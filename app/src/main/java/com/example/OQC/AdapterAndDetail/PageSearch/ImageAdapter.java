package com.example.OQC.AdapterAndDetail.PageSearch;
...
import com.example.OQC.AdapterAndDetail.PageDetail.DataImageDetail;
...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    ...
    private List<DataImageDetail> imageList; // Danh sách ảnh (resource ID hoặc URL)

    public ImageAdapter(Context context, List<DataImageDetail> imageList) {
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        DataImageDetail image = imageList.get(position);
        if (image == null) {
    ...
    public void updateData(List<DataImageDetail> newImageList) {
