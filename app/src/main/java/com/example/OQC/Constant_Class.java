...
public class Constant_Class {
    public static final String UpdateName = "Tablet_OQCxuathang";
    public static final String Update_serverAPK = "Tablet_OQCXH.apk";
    public static final String server = "PHP";
    public static final String mbaseUrl = "http://172.16.40.20/PHP/ShippingOQCAPP/";
